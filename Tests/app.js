...
//       random(-7, 7),
//       random(-7, 7),
//       `rgb(${random(0, 255)}, ${random(0, 255)}, ${random(0, 255)}), ${random(10, 20)}`
//     );
//     balls.push(ball);
//   }
...
//   text = document.createTextNode(' - the premier source for web developer knowledge.'),
//   linkPara = document.querySelector('p');

// link.tetContent = 'Mozilla Developer Network';
// link.href = 'https://developer.mozilla.org';
// para.textContent = 'We hope you enjoyed the ride.';
// sect.appendChild(para);
// linkPara.appendChild(text);

// Node.appendChild / cloneNode / removeChild
// sect.appendChild(linkPara);
// sect.cloneNode(linkPara);
// sect.removeChild(linkPara);
// linkPara.parentNode.removeChild(linkPara);

// HTMLElement.style / Element.setAttribute()
